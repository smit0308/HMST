...
urlpatterns = [
    ...
    path('registerlaboratory/', views.register_laboratory, name='register_laboratory'),
    ...
    path('get_available_laboratories/<int:service_id>/', views.get_available_laboratories, name='get_available_laboratories'),
    ...
    path('notification/sent/', views.notification_sent, name='notification_sent'),
